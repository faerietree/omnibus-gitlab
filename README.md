...
The documentation overview is in the [readme in the doc directory](doc/index.md).
...
*We left the links below in the readme to preserve old links, but please use the [readme in the doc directory](doc/index.md) to browse the complete documentation.*
